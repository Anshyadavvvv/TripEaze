...
import ChakrataMoilaTop from "../assets/ChakrataMoilaTop.png";
import { NavLink } from "react-router-dom";
export default function ChakrataMoila() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <style>{`
        ...
        .chakrata-fade-1 { animation: fadeInUp 0.7s ease-out both; }
        .chakrata-fade-2 { animation: fadeInUp 0.7s ease-out 0.12s both; }
        .chakrata-fade-3 { animation: fadeInUp 0.7s ease-out 0.24s both; }
      `}</style>
      ...
      <section className="relative h-[62vh] min-h-[420px] w-full overflow-hidden bg-[#0B1330]">
        <img
          src={ChakrataMoilaTop}
          alt="Moila Top ridge near Chakrata"
        ...
        <div className="absolute bottom-8 left-0 w-full px-6 sm:px-10">
          <div className="mx-auto max-w-6xl">
            <span className="chakrata-fade-1 inline-block rounded-full bg-[#3FA8DE] px-4 py-1.5 text-[12px] font-bold uppercase tracking-wide text-white">
              Nature · 1N/2D
            </span>
            <h1
              className="chakrata-fade-2 mt-4 text-[38px] font-bold leading-tight text-white sm:text-[54px]"
              style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}
            >
              Chakrata – Tiger Falls
            </h1>
            <p className="chakrata-fade-3 mt-2 max-w-xl text-[15px] text-white/70">
              A quick escape into pine ridgelines, mysterious caves and a
              waterfall trek — perfect for a weekend that doesn't eat into your
              leaves.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 sm:px-10 lg:grid-cols-3">
          ...
          <div className="space-y-14 lg:col-span-2">
            ...
            <div>
              ...
              <div className="relative mt-8 space-y-8 border-l-2 border-dashed border-[#0B1330]/15 pl-8">
                <TimelineItem
                  accent="#F2894E"
                  day="Day 0"
                  text="Boarding Bus from Delhi"
                />
                <TimelineItem
                  accent="#E8637A"
                  day="Day 1"
                  text="Reach Chakrata | Visit Lokhandi | Mysterious Budher Caves | Moila Top"
                />
                <TimelineItem
                  accent="#3FA8DE"
                  day="Day 2"
                  text="Tiger Falls | Chirimiri Sunset Point | Chakrata Market | Departure"
                  last
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-8 space-y-5">
                <DayCard accent="#F2894E" day="0" title="Departure from Delhi">
                  ...
                  <li>
                    Afterwards, you'll get a small briefing from the trip
                    leader.
                  </li>
                ...
                <DayCard
                  accent="#E8637A"
                  day="1"
                  title="Reach Chakrata & Visit Lokhandi | Mysterious Budher Caves | Moila Top"
                >
                  <li>Reach Chakrata early morning.</li>
                  <li>
                    Freshen up, have breakfast and enjoy the beautiful view from
                    the resort.
                  </li>
                  <li>
                    After a little rest, get ready to visit Budher Caves & Moila
                    Top — an easy trek from Lokhandi Snow View Point.
                  </li>
                  <li>Reach back to the resort after trekking.</li>
                  <li>Enjoy bonfire & dinner later.</li>
                  <li className="mt-2 font-semibold text-[#0B1330]/80">
                    Trek Note:
                  </li>
                  <li>
                    From Lokhandi Snow View Point, there is a 2.5 km flat trek
                    leading to the Forest Guest House.
                  </li>
                  <li>
                    From there, the trail continues with a 2.5 km uphill trek to
                    reach Moila Top.
                  </li>
                </DayCard>
                ...
                <DayCard
                  accent="#3FA8DE"
                  day="2"
                  title="Tiger Falls | Chirimiri Sunset Point | Chakrata Market"
                >
                  <li>
                    Enjoy a beautiful morning from the resort and have
                    breakfast.
                  </li>
                  <li>Check out from the resort after breakfast.</li>
                  <li>
                    Visit Tiger Falls — around 20 km drive followed by a 1 km
                    trek.
                  </li>
                  <li>
                    Later, visit Chirimiri Sunset Point in the evening and enjoy
                    breathtaking 360-degree Himalayan views.
                  </li>
                  <li>Visit Chakrata Market in the late evening.</li>
                  <li>Depart back to Delhi around 8:00 PM.</li>
                  <li>Pit stop for dinner at night.</li>
                </DayCard>
                ...
                >
                  <li>
                    Reach Delhi early in the morning with lots of memories and
                    endless pictures.
                  </li>
                  <li>Bid goodbye to fellow travelers.</li>
                </DayCard>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
                ...
                <ul className="mt-4 space-y-3 text-[14px] text-[#0B1330]/70">
                  <CheckItem>1 Night stay at Chakrata Resort</CheckItem>
                  <CheckItem>3 Meals — 2 Breakfast, 1 Dinner</CheckItem>
                  <CheckItem>Transfer to/from in AC Deluxe Bus/TT</CheckItem>
                  <CheckItem>
                    Assistance of trip coordinator or crew members
                  </CheckItem>
                  <CheckItem>Bonfire (weather permitting)</CheckItem>
                </ul>
              </div>
              ...
              <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
                ...
                <ul className="mt-4 space-y-3 text-[14px] text-[#0B1330]/70">
                  ...
                  <CrossItem>
                    Local taxi from Lokhandi and back to Lokhandi
                  </CrossItem>
                  <CrossItem>Entry tickets at viewpoints</CrossItem>
                  <CrossItem>Any expense not mentioned in inclusions</CrossItem>
                  <CrossItem>
                    Additional cost due to natural circumstances beyond our
                    control
                  </CrossItem>
                </ul>
              </div>
            ...
            <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
              ...
              <ul className="mt-5 space-y-3 text-[14px] text-[#0B1330]/70">
                <CheckItem>Booking Amount: ₹2000 per person</CheckItem>
            ...
            <div>
              ...
              <div className="mt-6 space-y-3">
                <CancelRow
                  color="#22C55E"
                  window="More than 60 days before departure"
                >
                  Free cancellation. Booking amount is non-refundable.
                </CancelRow>
                <CancelRow color="#F5A83C" window="59–45 days before departure">
                  Booking amount (non-refundable) + 10% of remaining trip cost
                  charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#F2894E" window="44–30 days before departure">
                  Booking amount (non-refundable) + 25% of remaining trip cost
                  charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#E8637A" window="29–15 days before departure">
                  Booking amount (non-refundable) + 50% of remaining trip cost
                  charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#D64550" window="15–8 days before departure">
                  Booking amount (non-refundable) + 75% of remaining trip cost
                  charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#0B1330" window="Within 7 days of departure">
                  Booking amount (non-refundable) + 100% of remaining trip cost
                  charged. No refund.
                </CancelRow>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-3xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_10px_40px_-10px_rgba(11,19,48,0.15)]">
              ...
              <div className="mt-6 space-y-3">
                <PriceRow label="Double Sharing" price="₹4,999" />
                <PriceRow label="Triple Sharing" price="₹4,799" />
                <PriceRow label="Quad Sharing" price="₹4,499" best />
              </div>
              ...
              <NavLink
                to="/packages/chakrata-moila/enquiry"
              ...
              <a
                href="https://wa.me/919929190452?text=Hi!%20I'm%20interested%20in%20the%20Chakrata%20%E2%80%93%20Tiger%20Falls%20package."
                target="_blank"
                rel="noreferrer"
