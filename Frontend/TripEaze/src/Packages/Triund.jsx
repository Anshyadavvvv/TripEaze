...
import Triund2 from "../assets/Triund2.png";
import { NavLink } from "react-router-dom";
export default function Triund() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <style>{`
        ...
        .triund-fade-1 { animation: fadeInUp 0.7s ease-out both; }
        .triund-fade-2 { animation: fadeInUp 0.7s ease-out 0.12s both; }
        .triund-fade-3 { animation: fadeInUp 0.7s ease-out 0.24s both; }
      `}</style>
      ...
      <section className="relative h-[62vh] min-h-[420px] w-full overflow-hidden bg-[#0B1330]">
        <img
          src={Triund2}
          alt="Triund camping under the Dhauladhar range"
        ...
        <div className="absolute bottom-8 left-0 w-full px-6 sm:px-10">
          <div className="mx-auto max-w-6xl">
            <span className="triund-fade-1 inline-block rounded-full bg-[#3FA8DE] px-4 py-1.5 text-[12px] font-bold uppercase tracking-wide text-white">
              Trek · 2N/3D
            </span>
            <h1
              className="triund-fade-2 mt-4 text-[38px] font-bold leading-tight text-white sm:text-[54px]"
              style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}
            >
              McLeodganj – Triund Trek
            </h1>
            <p className="triund-fade-3 mt-2 max-w-xl text-[15px] text-white/70">
              Monastery mornings, a climb through pine forest, and a night of
              camping under the Dhauladhar range — closer than you'd think.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 sm:px-10 lg:grid-cols-3">
          ...
          <div className="space-y-14 lg:col-span-2">
            ...
            <div>
              ...
              <div className="relative mt-8 space-y-8 border-l-2 border-dashed border-[#0B1330]/15 pl-8">
                ...
                <TimelineItem
                  accent="#E8637A"
                  day="Day 1"
                  text="Mcleodganj Exploration | Dalai Lama Monastery | Dinner & Stay"
                />
                <TimelineItem
                  accent="#3FA8DE"
                  day="Day 2"
                  text="Trek to Triund | Dinner & Camping"
                />
                <TimelineItem
                  accent="#F5A83C"
                  day="Day 3"
                  text="Explore Dharamshala Local | Cafe Hopping | Departure"
                />
                <TimelineItem
                  accent="#0B1330"
                  day="Day 4"
            ...
            <div>
              ...
              <div className="mt-8 space-y-5">
                ...
                >
                  <li>Reach Dharamshala and transfer to Mcleodganj by taxi.</li>
                  <li>
                    After reaching Mcleodganj, hotel check-in & freshen up.
                  </li>
                  <li>Visit:</li>
                  <ul className="ml-5 list-[circle] space-y-1">
                    <li>Bhagsu Waterfall</li>
                    <li>Dalai Lama Monastery</li>
                    <li>Mcleodganj Flea Market</li>
                  </ul>
                  <li>Return to the stay site.</li>
                  <li>Enjoy Bonfire & Music with fellow travellers.</li>
                ...
                <DayCard
                  accent="#3FA8DE"
                  day="2"
                  title="Trek to Triund | Camping"
                >
                  <li>Have your breakfast at the hotel.</li>
                  <li>Proceed for the Triund Trek with a trek guide.</li>
                  <li>
                    Reach Triund in the evening and enjoy the beautiful views of
                    the Dhauladhar Ranges.
                  </li>
                  <li>Check in to the camps.</li>
                  <li>Dinner & overnight stay under millions of stars.</li>
                </DayCard>

                <DayCard
                  accent="#F5A83C"
                  day="3"
                  title="Dharamshala Local | Cafe Hopping | Departure"
                >
                  <li>Wake up with a beautiful sunrise and enjoy breakfast.</li>
                  <li>Trek down to Mcleodganj.</li>
                  <li>Collect your luggage.</li>
                  <li>Visit:</li>
                  <ul className="ml-5 list-[circle] space-y-1">
                    <li>Dharamshala Stadium</li>
                    <li>Tea Garden (if time permits)</li>
                  </ul>
                  <li>
                    Head back to Delhi in the evening with wonderful trip
                    memories.
                  </li>
                </DayCard>
                ...
                >
                  <li>
                    Reach Delhi/Chandigarh early in the morning with lots of
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
                ...
                <ul className="mt-4 space-y-3 text-[14px] text-[#0B1330]/70">
                  <CheckItem>1 Night stay at Mcleodganj Hotel</CheckItem>
                  <CheckItem>1 Night camping at Triund</CheckItem>
                  <CheckItem>5 Meals — 3 Breakfast, 2 Dinner</CheckItem>
                  <CheckItem>Transfer to/from in AC Deluxe Bus/TT</CheckItem>
                  <CheckItem>Mcleodganj/Dharamshala sightseeing</CheckItem>
              ...
              <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
                ...
                <ul className="mt-4 space-y-3 text-[14px] text-[#0B1330]/70">
                  ...
                  <CrossItem>Forest Entry Fee</CrossItem>
                  <CrossItem>Entry tickets to viewpoints</CrossItem>
            ...
            <div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <CancelRow color="#F5A83C" window="59–45 days before departure">
                  Booking amount (non-refundable) + 10% of the remaining trip
                  cost charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#F2894E" window="44–30 days before departure">
                  Booking amount (non-refundable) + 25% of the remaining trip
                  cost charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#E8637A" window="29–15 days before departure">
                  Booking amount (non-refundable) + 50% of the remaining trip
                  cost charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#D64550" window="15–8 days before departure">
                  Booking amount (non-refundable) + 75% of the remaining trip
                  cost charged. Remaining amount refunded.
                </CancelRow>
                <CancelRow color="#0B1330" window="Within 7 days of departure">
                  Booking amount (non-refundable) + 100% of the remaining trip
                  cost charged. No refund.
                </CancelRow>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-3xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_10px_40px_-10px_rgba(11,19,48,0.15)]">
              ...
              <div className="mt-6 space-y-3">
                <PriceRow label="Double Sharing" price="₹6,999" />
                <PriceRow label="Triple Sharing" price="₹6,499" />
                <PriceRow label="Quad Sharing" price="₹5,999" best />
              </div>
              ...
              <a
                href="https://wa.me/919929190452?text=Hi!%20I'm%20interested%20in%20the%20Triund%20Trek%20package."
                target="_blank"
                rel="noreferrer"
