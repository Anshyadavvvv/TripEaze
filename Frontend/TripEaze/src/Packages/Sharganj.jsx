...
import ShangarhImage from "../assets/Shangarh.png";
import { NavLink } from "react-router-dom";
export default function Shangarh() {
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <style>{`
        ...
        .shangarh-fade-1 { animation: fadeInUp 0.7s ease-out both; }
        .shangarh-fade-2 { animation: fadeInUp 0.7s ease-out 0.12s both; }
        .shangarh-fade-3 { animation: fadeInUp 0.7s ease-out 0.24s both; }
      `}</style>
      ...
      <section className="relative h-[62vh] min-h-[420px] w-full overflow-hidden bg-[#0B1330]">
        <img
          src={ShangarhImage}
          alt="Sainj Valley Shangarh meadows and mountains"
        ...
        <div className="absolute bottom-8 left-0 w-full px-6 sm:px-10">
          <div className="mx-auto max-w-6xl">
            <span className="shangarh-fade-1 inline-block rounded-full bg-[#F5A83C] px-4 py-1.5 text-[12px] font-bold uppercase tracking-wide text-[#0B1330]">
              Nature & Trekking · 2N/3D
            </span>
            <h1
              className="shangarh-fade-2 mt-4 text-[38px] font-bold leading-tight text-white sm:text-[54px]"
              style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}
            >
              Sainj Valley | Shangarh
            </h1>
            <p className="shangarh-fade-3 mt-2 max-w-xl text-[15px] text-white/70">
              Lush green meadows, ancient temples, hidden waterfalls, and serene
              alpine lakes — explore the untouched beauty of Sainj Valley.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 sm:px-10 lg:grid-cols-3">
            ...
            <div>
              ...
              <div className="relative mt-8 space-y-8 border-l-2 border-dashed border-[#0B1330]/15 pl-8">
                ...
                <TimelineItem
                  accent="#E8637A"
                  day="Day 1"
                  text="Explore Shangarh | Barshangarh Waterfall | Shangchul Mahadev Temple"
                />
                <TimelineItem
                  accent="#3FA8DE"
                  day="Day 2"
                  text="Trek to Pundrik Rishi Lake | Temple Visit"
                />
                <TimelineItem
                  accent="#F5A83C"
                  day="Day 3"
                  text="Raila Waterfall Visit | River Rafting | Departure"
                />
                <TimelineItem
                  accent="#0B1330"
                  day="Day 4"
                  text="Reach back to Delhi with Everlasting Memories"
                  last
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-8 space-y-5">
                ...
                <DayCard
                  accent="#E8637A"
                  day="1"
                  title="Explore Shangarh, Barshangarh Waterfall & Shangchul Mahadev Temple"
                >
                  <li>
                    Arrive in Shangarh by morning and check in to your homestay
                    or campsite.
                  </li>
                  <li>
                    After freshening up, head out to explore the serene
                    Barshangarh Waterfall and visit the sacred Shangchul Mahadev
                    Temple.
                  </li>
                  <li>
                    Return to your stay by evening for dinner and enjoy a
                ...
                <DayCard
                  accent="#3FA8DE"
                  day="2"
                  title="Trek to Pundrik Rishi Lake & Temple Visit"
                >
                  <li>
                    Wake up to refreshing mountain views and start your day with
                    breakfast.
                  </li>
                  <li>
                    Spend some leisure time exploring nearby spots before
                    heading out for a short yet scenic trek (3–4 km) to Pundrik
                    Rishi Lake.
                  </li>
                  <li>
                    Walk through lush meadows and enjoy the tranquil
                    surroundings.
                  </li>
                  <li>End the day with dinner and an overnight stay.</li>
                </DayCard>

                <DayCard
                  accent="#F5A83C"
                  day="3"
                  title="Raila Waterfall Visit | River Rafting | Departure"
                >
                  <li>
                    Check out from your homestay/campsite after breakfast.
                  </li>
                  <li>
                    Proceed towards Raila village for the day's adventure. Enjoy
                    a short hike (approx. 1 km) to the stunning Rupi Raila
                    Waterfall.
                  </li>
                  <li>
                    You can also experience river rafting (optional, approx.
                    ₹500 per person).
                  </li>
                  <li>
                    Later in the evening, begin your journey back to Delhi.
                  </li>
                </DayCard>
                ...
                >
                  <li>
                    We'll reach Delhi / Chandigarh early in the morning with a
                    bucketload of memories and endless pictures.
                  </li>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
                ...
                <ul className="mt-4 space-y-3 text-[14px] text-[#0B1330]/70">
                  <CheckItem>Accommodation (Homestay / Campsite)</CheckItem>
                  <CheckItem>5 Meals (3 Breakfast & 2 Dinner)</CheckItem>
              ...
              <div className="rounded-2xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_2px_10px_rgba(11,19,48,0.04)]">
                ...
                <ul className="mt-4 space-y-3 text-[14px] text-[#0B1330]/70">
                  ...
                  <CrossItem>Any entry ticket at the viewpoints</CrossItem>
                  <CrossItem>Expenses not included in inclusions</CrossItem>
                  <CrossItem>
                    Extra costing due to natural circumstances beyond control
                  </CrossItem>
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <CancelRow color="#F5A83C" window="59–45 days before departure">
                  10% of the total trip cost (calculated after subtracting the
                  booking amount) along with the non-refundable booking amount
                  will be charged as a cancellation fee, and the remaining
                  amount will be refunded.
                </CancelRow>
                <CancelRow color="#F2894E" window="44–30 days before departure">
                  25% of the total trip cost (calculated after subtracting the
                  booking amount) along with the non-refundable booking amount
                  will be charged as a cancellation fee, and the remaining
                  amount will be refunded.
                </CancelRow>
                <CancelRow color="#E8637A" window="29–15 days before departure">
                  50% of the total trip cost (calculated after subtracting the
                  booking amount) along with the non-refundable booking amount
                  will be charged as a cancellation fee, and the remaining
                  amount will be refunded.
                </CancelRow>
                <CancelRow color="#D64550" window="15–8 days before departure">
                  75% of the total trip cost (calculated after subtracting the
                  booking amount) along with the non-refundable booking amount
                  will be charged as a cancellation fee, and the remaining
                  amount will be refunded.
                </CancelRow>
                <CancelRow color="#0B1330" window="Within 7 days of departure">
                  100% of the total trip cost (calculated after subtracting the
                  booking amount) along with the non-refundable booking amount
                  will be charged as a cancellation fee, and no remaining amount
                  will be refunded.
                </CancelRow>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-3xl border border-[#0B1330]/[0.06] bg-white p-6 shadow-[0_10px_40px_-10px_rgba(11,19,48,0.15)]">
              ...
              <NavLink
                to="/packages/shangarh-sainj/enquiry"
              ...
              <a
                href="https://wa.me/919929190452?text=Hi!%20I'm%20interested%20in%20the%20Sainj%20Valley%20%7C%20Shangarh%20package."
                target="_blank"
                rel="noreferrer"
